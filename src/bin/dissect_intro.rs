...
use pfr::assets::intro::{Assets, TextPage};
...
fn main() -> std::io::Result<()> {
    ...
    save_png(&assets.slides[0].image, &args.output_dir, "logo0.png")?;
    save_png(&assets.slides[1].image, &args.output_dir, "logo1.png")?;
    save_png(&assets.slides[2].image, &args.output_dir, "logo2.png")?;
    save_png(&assets.slides[3].image, &args.output_dir, "presents.png")?;
    save_png(&assets.slides[4].image, &args.output_dir, "pflogo.png")?;
